...
jQuery(document).ready(function(){
	jQuery("#crd_card_link").on("click", function(){
		jQuery('#block-credit-card-voucher-credit-card').show();
		jQuery('#block-credit-card-voucher-voucher').hide();
	}); 

	jQuery("#voucher_link").on("click", function(){
		jQuery('#block-credit-card-voucher-credit-card').hide();
		jQuery('#block-credit-card-voucher-voucher').show();
	});
});	
